...
export interface ConsulTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export namespace InitialMintCompletedEvent {
...
export interface ConsulToken extends BaseContract {
  connect(runner?: ContractRunner | null): ConsulToken;
  waitForDeployment(): Promise<this>;

  interface: ConsulTokenInterface;
  ...
  >;
  getEvent(
    key: "InitialMintCompleted"
  ): TypedContractEvent<
    InitialMintCompletedEvent.InputTuple,
    InitialMintCompletedEvent.OutputTuple,
    InitialMintCompletedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "InitialMintCompleted(address,uint256)": TypedContractEvent<
      InitialMintCompletedEvent.InputTuple,
      InitialMintCompletedEvent.OutputTuple,
      InitialMintCompletedEvent.OutputObject
    >;
    InitialMintCompleted: TypedContractEvent<
      InitialMintCompletedEvent.InputTuple,
      InitialMintCompletedEvent.OutputTuple,
      InitialMintCompletedEvent.OutputObject
    >;
